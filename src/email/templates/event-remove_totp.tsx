...
export const templateName = "Event: TOTP Removed";
...
export const Template = ({ locale }: TemplateProps) => (
  <Html lang={locale}>
    <Head />
    <Preview>Two-factor authentication removed from {exp("realmName")}</Preview>
    <Body style={styles.body}>
      <Container style={styles.container}>
        <div style={styles.headerDecoration} />
        <Text style={styles.heading}>2FA Removed</Text>
        ...
        <Text style={styles.paragraph}>
          ...
          <strong>{exp("realmName")}</strong> account. Your account is now less
          secure.
        </Text>
